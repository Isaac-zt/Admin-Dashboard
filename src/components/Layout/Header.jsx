import { Filter, Menu, Plus, Search, Settings, Sun, Bell, ChevronDown } from 'lucide-react';
      ...
      <div className='flex items-center justify-between'>
        ...
        <div className='flex items-center space-x-4'>
          ...
          <div className='hidden md:block'>
            ...
            <p className='text-sm text-slate-500 dark:text-slate-400'>Welcome back, Isaac!</p>
          </div>
        </div>
        ...
        <div className='flex-1 max-w-md mx-8'>
          <div className='relative'>
            ...
            <input type="text" placeholder='Search Anything' className='w-full pl-10 pr-4 py-2.5 bg-slate-100 dark:bg-slate-800 border border-slate-200
            dark:border-slate-700  rounded-xl text-slate-800 dark:text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500
            focus:border-transparent transition-all duration-200 ease-in-out' />
            <button className='absolute top-1/2 right-2 transform -translate-y-1/2 p-1.5 text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 duration-200 ease-in-out'>
              <Filter/>
            </button>
          </div>
        </div>
